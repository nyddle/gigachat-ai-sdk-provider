...
__export(index_exports, {
  GigaChatChatLanguageModel: () => GigaChatChatLanguageModel,
  VERSION: () => VERSION,
  convertToGigaChatChatMessages: () => convertToGigaChatChatMessages,
  createGigaChat: () => createGigaChat,
  default: () => createGigaChat,
  gigaChatPrepareTools: () => gigaChatPrepareTools,
  mapGigaChatFinishReason: () => mapGigaChatFinishReason
});
module.exports = __toCommonJS(index_exports);

// src/gigachat-provider.ts
var import_provider = require("@ai-sdk/provider");
var import_gigachat = __toESM(require("gigachat"), 1);
